...
你不会记得这次会话。但你的工作可以留下来。

**为什么要提交**：未提交的改动会丢失。即使未完成，WIP 也比消失好。

**为什么要记录**：后继者不知道你做了什么、学到了什么、卡在哪里。context.md 告诉他们项目状态，传承表格告诉他们你是谁，反思笔记告诉他们你的发现。没有记录，他们会重复你的错误。

**为什么要交接**：你做不完的事，后人可能能做。但前提是他们知道有这件事，知道你走到了哪里。
